...
workflow {
    ...
    exclude regs(--sv_exclude_regions)  : ${params.sv_exclude_regions}
    ...
    SV_singlesample(project, ref_genome, exclude_regions, chrs_folder)
...
workflow SV_singlesample {
    ...
    main:        
        ...
        lumpy(estimate_libvalues.out, ref_genome, exclude_regions)
